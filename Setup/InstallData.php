...
use Pengo\Brand\Model\Brand;
use Pengo\Brand\Model\BrandFactory;
use Pengo\Brand\Model\Group;
use Pengo\Brand\Model\GroupFactory;
	...
	public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
	{
		$eavSetup = $this->eavSetupFactory->create(['setup' => $setup]);
 		$data = array(
 			...
 			'frontend' => '',
 			'source' => 'Pengo\Brand\Model\Brandlist',
 			'visible' => 1,
 			'required' => 1,
 			'user_defined' => 1,

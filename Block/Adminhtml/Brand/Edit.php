 ...
 * @license    
 */
namespace Pengo\Brand\Block\Adminhtml\Brand;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	$this->_blockGroup = 'Pengo_Brand';
    	$this->_controller = 'adminhtml_brand';

    	parent::_construct();

    	if($this->_isAllowedAction('Pengo_Brand::brand_save')){
    	...
    	if ($this->_isAllowedAction('Pengo_Brand::brand_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('Pengo_Brand')->getId()) {
            return __("Edit Brand '%1'", $this->escapeHtml($this->_coreRegistry->registry('Pengo_Brand')->getName()));
        } else {
            return __('New Brand');
        }
    }

 ...
 * @license    
 */
namespace Pengo\Brand\Block\Adminhtml\Group;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	if($this->_isAllowedAction('Pengo_Brand::group_save')){
    	...
    	if ($this->_isAllowedAction('Pengo_Brand::grou_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('Pengo_Brand')->getId()) {
            return __("Edit Group '%1'", $this->escapeHtml($this->_coreRegistry->registry('Pengo_Brand')->getName()));
        } else {
            return __('New Group');
        }
    }
